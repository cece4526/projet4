...
if ($this->session->get('pseudo')) {?>
    <nav id="menu_dir" class="col navbar navbar-expand-lg">
        ...
        <div id="navbarContent" class="collapse navbar-collapse menu_dir">
            <ul class="navbar-nav">
                <li class="nav-item active"><a id="bouton4" class=" nav-link" href="../public/index.php?route=logout">Déconnexion</a></li>
                <li class="nav-item active"><a id="bouton4" class=" nav-link" href="../public/index.php?route=profile">Profil</a></li>
                <?php if($this->session->get('role') === 'admin') { ?>
                <li class="nav-item active"><a id="bouton4" class="nav-link" href="../public/index.php?route=administration">Administration</a></li>
            </ul>
        </div>
        <?php } ?>
    </nav>
    ...
    <nav id="menu_dir" class="col navbar navbar-expand-lg">
        ...
        <div id="navbarContent" class="collapse navbar-collapse menu_dir">
            <ul class="navbar-nav">
                <li class="nav-item active"><a id="bouton4" class="nav-link" href="../public/index.php?route=register">Inscription</a></li>
                <li class="nav-item active"><a id="bouton4" class="nav-link" href="../public/index.php?route=login">Connexion</a></li>
            </ul>
        </div>
    </nav>
    <?php
...
{
    ?>
    <article id="color_article" class=" card card_home_center ">
